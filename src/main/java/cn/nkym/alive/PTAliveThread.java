...
public class PTAliveThread {
    ...
    public static void keepAlive(){
        ...
        while (StringUtils.isNotBlank(properties.getProperty("pt.uri" + count))){
            ...
            new Thread(() -> PTVisit.visit(properties.getProperty("pt.uri" + finalCount), properties.getProperty("pt.cookie" + finalCount), finalName)).start();
            count++;
        }
    }
}
